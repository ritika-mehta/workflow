            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspManage Subscription plan
                            </h4>
                        </div>
                        <div class="actions">
                            <div class="btn-group">
                               <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('subscriptions.subscription.create') }}');"><i class="fa fa-plus"></i>
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    ...
                                    <th width="350" class="tablet-l desktop">no of clicks</th>
                                    <th width="350" class="tablet-l desktop">valid days</th>
    ...
    <script>
        jQuery(document).ready(function() {
            sort_arr = [
                ...
                {data: 'no_of_clicks', name: 'no_of_clicks', "bSortable": false},
                {data: 'valid_days', name: 'valid_days', "bSortable": false},
