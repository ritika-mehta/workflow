            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                               <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('manage_banners.manage_banner.create') }}');"><i class="fa fa-plus"></i>
                                    Create Banners
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="table-container">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                                <thead>
                                    ...
                                    <th width="400" class="all">Tiitle</th>
                                    <th width="400" class="all">Type</th>
                                    <th width="350" class="tablet-l desktop">Image/Video</th>
                                    <th width="350" class="tablet-l desktop">Total Clicks</th>
                                    <th width="350" class="tablet-l desktop">Total Views</th>
    ...
    <script>
        jQuery(document).ready(function() {
            sort_arr = [
                ...
                {data: 'banner_type', name: 'banner_type', "bSortable": false},
                {data: 'image', name: 'image', "bSortable": false},
                {data: 'total_clicks', name: 'total_clicks', "bSortable": true},
