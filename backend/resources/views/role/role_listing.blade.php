            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        <h4 class="caption-subject bold uppercase"><i class="fa fa-list"></i>&nbspRole Management
                        </h4>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                            <button class="btn sbold green" onclick="redirect_url($(this),'{{ route('admin.role.add') }}');"><i class="fa fa-plus"></i>
                                Add New Role
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive table-checkable service-table" id="datatable_ajax">
                            <thead>
                                ...
                                <th width="300" class="all">Role Name</th>
                                <th width="200" class="tablet-p tablet-l desktop">Description</th>
                                <th width="200" class="tablet-p tablet-l desktop">Status</th>
                                <th width="200" class="tablet-p tablet-l desktop">Created</th>
                                <th width="200" class="tablet-p tablet-l desktop">Action</th>
                                </tr>
