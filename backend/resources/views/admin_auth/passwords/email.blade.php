...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="hide login-form" action="index.html" method="post">
                ...
                <div class="form-actions">
                    ...
                    <div class="forget-password">
                        <h4><a href="{{url('admin/password/reset')}}" style="color: white;">Click here to reset password</a></h4>
                    </div>
                </div>
            </form>
            ...
            <form class="login-form" action="{{ url('/admin/password/email') }}" method="post" novalidate="novalidate" style="display: block;">
